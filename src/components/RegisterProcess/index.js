            ...
            <section className="process lazy-load" id="process">
                ...
                <div className="container">
                    ...
                    <div className="method__left col-xs-12 col-sm-6 custom-position">
                        ...
                        <p className="method__row__text">Trước khi học cùng dự án, học viên cần thực hiện bài kiểm tra đánh giá năng lực để biết được trình độ của mình. Làm <Link to="/danh-gia-nang-luc">tại đây.</Link></p>
                    </div>
