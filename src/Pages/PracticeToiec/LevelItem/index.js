                        ...
                        <div className="container">
                            <div className="row pt-80">
                                ...
                                <div className="col-sm-6">
                                    <div className="card-level">
                                        <div className="card-box">
                                            <img className="card-level-img" src={iconTOIEC650plus} alt="" />
                                            <h1 className="card-level-title">Cấp độ 650+</h1>
                                            <p className="card-level-description mb-18">
                                                Điểm số TOEIC 650 - 750+ là mong muốn của đa số các bạn thí sinh luyện thi chứng chỉ này.
                                            </p>
                                            <h4 className="card-level-title-list">
                                ...
                                <div className="col-sm-6">
                                    <div className="card-level">
                                        <div className="card-box card-box-certificate-b">
                                            <img className="card-level-img" src={iconTOIEC800plus} alt="" />
                                            <h1 className="card-level-title">Cấp độ 800+</h1>
                                            <p className="card-level-description mb-18">
                                                Điểm số TOEIC 800+ là một số điểm có thể được gọi là cao đối với trình độ trung bình của các bạn sinh viên hiện nay,
                                            ...
                                            <ul className="card-level-list pb-0 card-level-list-content">
                                                <li>
                                                    <img className="img-icon" src={iconList} alt="" />
                                                    <div className="card-level-list-item">
                                                        Hoành thành khoá học "Cấp độ 650+"
                                                    </div>
                                                </li>
                                                <li>
                                                    <img className="img-icon" src={iconList} alt="" />
                                                    <div className="card-level-list-item">
                                                    Có điểm thi TOEIC đạt 650+ không quá 4 tháng.
                                                    </div>
                                                </li>
                                                <li>
                                                    <img className="img-icon" src={iconList} alt="" />
