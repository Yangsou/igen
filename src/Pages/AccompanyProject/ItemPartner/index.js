...
import image6 from '../../../assets/img/HinhGV/TSLeHoanhSu.png';
        ...
        this.state = {
            ...
            partnerItem : [
                ...
                },
                {
                    ...
                    description: 'Dù là sinh viên năm nhất, hay sinh viên năm cuối, các bạn sinh viên nên tận dụng thời gian để cải thiện trình độ tiếng Anh của mình. Với iGen - một dự án thú vị, tôi nghĩ việc đó không còn là khó khăn nữa.'
                },
                {
                    name : 'TS. Lê Hoành Sử',
                ...
                },
                {
                    ...
                    position: ['Phó Giám Đốc Trung tâm Quan hệ doanh nghiệp'],
                    description: 'Các doanh nghiệp liên kết cùng nhà trường đánh giá rất cao iGen về tính cộng đồng cũng như giải pháp học tập theo xu hướng trực tuyến hiện nay. Một số doanh nghiệp đã cam kết đồng hành cùng dự án trong những năm sau nữa.'
                },
                // {
