...
import './../../../GeneralEnglish/LevelItem/styles.scss'
import './styles.scss'
                ...
                <section className="container-fluid bg-row">
                    <div className="container">
                        <div className="row wrap-flex-center">
                            {level === 'A1'?<div className="col-sm-6">
                            ...
                            {level==='A2'?<div className="col-sm-6">
                                <div className="card-level card-level-sub">
                                    <div className="card-box card-box-sub">
                            ...
                            {level==='B1'?<div className="col-sm-6">
                                <div className="card-level card-level-sub">
                            ...
                            {level==='B2'?<div className="col-sm-6">
                                <div className="card-level card-level-sub">
                                    <div className="card-box card-box-sub card-box-certificate-b">
                            ...
                            {level==='C1'?<div className="col-sm-6">
                                <div className="card-level card-level-sub">
                                    <div className="card-box card-box-sub card-box-certificate-c">
                            ...
                            {level==='C2'?<div className="col-sm-6">
                                <div className="card-level card-level-sub">
                                    <div className="card-box card-box-sub card-box-certificate-c">
